...
let page = 0;
let pageCount = 20;
export default class PublicOpinion extends React.Component{
    ...
    componentDidMount(){
      let apiUrl = `http://drsohanrajtater.com/api/public_opinion.php`;
      let pageNo = 0;
                ...
                <View style={styles.body}>
                    <TouchableHighlight key="profile">
                        <View style={styles.vids}>
                            <Text style={styles.pageHeading}>PUBLIC OPINION ABOUT PROF.(DR.) SOHAN RAJ TATER</Text>
                        </View>
                    </TouchableHighlight>
                    ...
                    <View style={styles.tabBar}>
                        {this.state.nextPageNo>1 &&
                            <TouchableHighlight key="previous" style={styles.tabItems}> 
                                    <Text style={styles.tabTitleTW} onPress={() => navigate('PublicOpinion', {
