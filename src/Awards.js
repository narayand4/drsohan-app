...
export default class Awards extends React.Component{
    ...
    componentDidMount(){
      let apiUrl = `http://drsohanrajtater.com/api/award.php`;
      let pageNo = 0;
                ...
                <View style={styles.body}>
                    <TouchableHighlight key="profile">
                        <View style={styles.vids}>
                            <Text style={styles.pageHeading}>AWARDS RECEIVED BY PROF.(DR.) SOHAN RAJ TATER</Text>
                        </View>
                    </TouchableHighlight>
                    ...
                    <View style={styles.tabBar}>
                        {this.state.nextPageNo>1 &&
                            <TouchableHighlight key="previous" style={styles.tabItems}> 
                                    <Text style={styles.tabTitleTW} onPress={() => navigate('Awards', {
