...
export default class Museum extends React.Component{
    ...
    componentDidMount(){
      let apiUrl = `http://drsohanrajtater.com/api/museum.php`;
      let pageNo = 0;
                ...
                <View style={styles.body}>
                    <TouchableHighlight key="profile">
                        <View style={styles.vids}>
                            <Text style={styles.pageHeading}>FULL MUSEUM RELATED TO PROF.(DR.) SOHAN RAJ TATER</Text>
                        </View>
                    </TouchableHighlight>
                    ...
                    <View style={styles.tabBar}>
                        {this.state.nextPageNo>1 &&
                            <TouchableHighlight key="previous" style={styles.tabItems}> 
                                    <Text style={styles.tabTitleTW} onPress={() => navigate('Museum', {
